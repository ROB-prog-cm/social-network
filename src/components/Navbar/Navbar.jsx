...
const Navbar = () => {
  return (
    <nav className={styles.nav}>
      ...
      <div className={styles.item}><NavLink to={"/dialogs"} activeClassName={styles.activeLink}>Message</NavLink></div>
      ...
      <div className={styles.item}><NavLink to={"/setting"} activeClassName={styles.activeLink}>Setting</NavLink></div>
    </nav>
  )
}
